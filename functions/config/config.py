...
class Config:
    ...
    DB_PASSWORD: str = os.environ.get("DB_PASSWORD", "REMOVED_SECRET")  # Fallback for development
    
    # API Keys
    GEMINI_API_KEY: str = os.environ.get("GEMINI_API_KEY", "REMOVED_SECRET")  # Fallback for development
    OPENROUTER_API_KEY: str = os.environ.get("OPENROUTER_API_KEY", "REMOVED_SECRET")  # Fallback for development
